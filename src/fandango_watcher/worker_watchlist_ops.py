"""Stdlib-only watchlist helpers for the Cloudflare Worker bundle."""
...
def build_movie_add_plan(
    ...
    *,
    ...
    new_targets.append({"name": overview_name, "url": overview_url})
    ...
    preferred_formats = (
        ["IMAX_70MM", "IMAX"] if include_imax_70mm else ["IMAX"]
    )
    movie = {
        "key": key,
        "title": title,
